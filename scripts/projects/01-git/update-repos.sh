...
measure_time "Updating ansible-common-tasks" update_git_repository "$GIT_DIR/datacenter/01-ansible" "ansible-common-tasks"
measure_time "Updating ansible-kvm-cloud-init" update_git_repository "$GIT_DIR/datacenter/01-ansible" "ansible-kvm-cloud-init"
...
measure_time "Updating 01-terraform-random-target-node" update_git_repository "$GIT_DIR/datacenter/03-terraform" "01-terraform-random-target-node"
measure_time "Updating 02-terraform-local-dynamic-inventory" update_git_repository "$GIT_DIR/datacenter/03-terraform" "02-terraform-local-dynamic-inventory"
...
measure_time "Updating 11-ai-instructions" update_git_repository "$GIT_DIR/datacenter/06-projects" "11-ai-instructions"
...
measure_time "Updating xx-nexus" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-nexus"
measure_time "Updating xx-openldap" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-openldap"
measure_time "Updating xx-portainer" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-portainer"
measure_time "Updating xx-postgresql" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-postgresql"
measure_time "Updating xx-rabbitmq" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-rabbitmq"
measure_time "Updating xx-redis" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-redis"
measure_time "Updating xx-sonarqube" update_git_repository "$GIT_DIR/datacenter/06-projects" "xx-sonarqube"
...
measure_time "Updating 02-home-edge-esxi" update_git_repository "$GIT_DIR/home" "02-home-edge-esxi"
measure_time "Updating 03-home-edge-firewall" update_git_repository "$GIT_DIR/home" "03-home-edge-firewall"
measure_time "Updating 04-home-edge-ldap" update_git_repository "$GIT_DIR/home" "04-home-edge-ldap"
measure_time "Updating 05-home-edge-postgresql" update_git_repository "$GIT_DIR/home" "05-home-edge-postgresql"
measure_time "Updating 06-home-edge-zabbix" update_git_repository "$GIT_DIR/home" "06-home-edge-zabbix"
